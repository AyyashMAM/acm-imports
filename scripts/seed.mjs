...
const products = [
  {
    ...
    variants: [
      { label: "Rose Nude", price: 9.99, stock_quantity: 25 },
      { label: "Cherry Red", price: 9.99, stock_quantity: 18 },
    ],
  },
  {
    ...
    variants: [{ label: "Set of 5", price: 14.99, stock_quantity: 30 }],
  },
  {
    ...
    variants: [{ label: "24 pcs", price: 18.99, stock_quantity: 20 }],
  },
  {
    ...
    variants: [
      { label: "Ivory", price: 6.99, stock_quantity: 20 },
      { label: "Gold", price: 6.99, stock_quantity: 20 },
    ],
  },
];
